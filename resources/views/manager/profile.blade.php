            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <h2 class="t-uppercase parkinsans-md">{{ $user->name }}</h2>
                        <h3 class="t-uppercase parkinsans-md">{{ $user->role }}</h3>
                    </div>
                </div>
              ...
              <div class="card-body pt-3">
                ...
                <div class="tab-content pt-2">
                    ...
                    <!-- Profile Edit Form -->
                        ...
                        <form action="{{ route('hrd.profile.update') }}" method="POST" id="profileForm">
                            @csrf
                    ...
                    <div class="tab-pane fade pt-3" id="profile-change-password">
                        ...
                        <form id="changePasswordForm" action="{{ route('hrd.change-password') }}" method="POST">
                            @csrf
                            <div class="row mb-3">
